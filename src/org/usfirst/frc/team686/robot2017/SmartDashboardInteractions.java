...
public class SmartDashboardInteractions 
{
    ...
    enum AutoModeOption 
    {
        ...
        STEAMWORKS_CENTER(" Center"),
        STEAMWORKS_BOILER("Boiler Gear"),
        STEAMWORKS_OTHER("Other Side"),
    	STEAMWORKS_BOILER_HOPPER("Boiler Hopper");
    ...
    public void initWithDefaults() 
    {
    	...
    	autoModeChooser.addObject( AutoModeOption.STEAMWORKS_BOILER_HOPPER.toString(), AutoModeOption.STEAMWORKS_BOILER_HOPPER);
